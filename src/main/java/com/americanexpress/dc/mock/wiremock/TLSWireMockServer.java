package com.americanexpress.dc.mock.wiremock;


import com.americanexpress.dc.mock.wiremock.core.TLSWireMockApp;
...
public class TLSWireMockServer extends WireMockServer
{
  ...
  private final TLSWireMockApp wireMockApp;
  ...
  public TLSWireMockServer( Options options )
  {
    this.options = options;
    this.notifier = options.notifier();

    wireMockApp = new TLSWireMockApp( options, this );
  ...
  public TLSWireMockServer( int port, Integer httpsPort, FileSource fileSource, boolean enableBrowserProxying, ProxySettings proxySettings, Notifier notifier )
  {
    this
        (
            wireMockConfig()
  ...
  public TLSWireMockServer( int port, FileSource fileSource, boolean enableBrowserProxying, ProxySettings proxySettings )
  {
    this
        (
            wireMockConfig()
  ...
  public TLSWireMockServer( int port, FileSource fileSource, boolean enableBrowserProxying )
  {
    this
        (
            wireMockConfig()
  ...
  public TLSWireMockServer( int port )
  {
    this( wireMockConfig().port( port ) );
  }

  public TLSWireMockServer( int port, Integer httpsPort )
  {
    this( wireMockConfig().port( port ).httpsPort( httpsPort ) );
  }

  public TLSWireMockServer()
  {
    this( wireMockConfig() );
  }
  ...
  {
    final TLSWireMockServer server = this;
