package com.americanexpress.dc.mock.wiremock.core;


import com.americanexpress.dc.mock.wiremock.http.TLSProxyResponseRenderer;
...
public class TLSWireMockApp implements StubServer, Admin
{
  ...
  public TLSWireMockApp( Options options, Container container )
  {
